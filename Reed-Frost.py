...
- **C**: The initial number of cases in the population
...
def reed_frost_model(p, c, s, b=0, i=0, d=0, m=0, time_periods=100):
    """
...
c = st.sidebar.number_input("Initial number of cases (C)", 1, 1000, 1)
s = st.sidebar.number_input("Initial number of susceptible individuals (S)", 1, 10000, 10)
...
results = reed_frost_model(p, c, s, b, i, d, m, time_periods)
