...
def run():    
    ...
    **Parameters:**
    ...
    # Academic interpretation toggle
    show_academic_interpretation = st.sidebar.checkbox("Show Academic Interpretations", True, 
                                                      help="Display interpretations based on vector biology literature")
    
    # Survival rates with literature context
    st.sidebar.subheader("Survival Rates (p)")
    if show_academic_interpretation:
        st.sidebar.markdown("""
    ...
    if show_academic_interpretation:
        ...
        **Vectorial Capacity Estimate:** {vectorial_capacity:.2f}
        ...
        Based on Black & Moore's discussion (p.397), vectorial capacity is the product of vector density, 
        ...
        **Growth Rate (r):** {r0_estimate:.4f}
        ...
        Comparable to the intrinsic rate of increase (r) in exponential growth models described in Fig 24.4.
        """)
    ...
    with tab1:
        ...
        ax2.set_title('Daily Population Growth Rate (comparable to r in Fig 24.4)', fontsize=14)
        ...
        if show_academic_interpretation:
            ...
            **Mean Growth Rate: {mean_growth:.2f}%**
            ...
            discussed in the exponential growth model (equation 14). When positive, the population 
    ...
    with tab2:
        ...
        if show_academic_interpretation:
            ...
            **Stable Age Distribution Analysis:**
            ...
            This chart demonstrates the concept of Stable Age Distribution (SAD) described in Figure 24.11. 
    ...
    with tab3:
        ...
        cohort_day = st.slider("Select day to start tracking a cohort:", 1, max(1, num_days-10), 1, 
                             help="Similar to survivorship curves in Figure 24.6")
        ...
        if initial_eggs > 0:
            ...
            ax5.set_title(f'Cohort Survival from Day {cohort_day} (Comparable to Fig. 24.6)', fontsize=14)
            ax5.legend(fontsize=10)
            ax5.grid(True, alpha=0.3)
            
            # Use log scale for y-axis to match Fig 24.6 survivorship curves
            if show_academic_interpretation:
                ax5.set_yscale('log')
                st.info("Using logarithmic scale for y-axis to match survivorship curve patterns in Figure 24.6")
            ...
            if show_academic_interpretation:
                # Determine survivorship curve type based on patterns in Fig 24.6
                survival_pattern = "Type II"  # Default
                
                # Check survival rate pattern to determine type (I, II, or III from Fig 24.6)
                ...
                **Survivorship Curve Analysis:**
                ...
                This cohort follows a **{survival_pattern}** survivorship pattern as described in Figure 24.6.
                ...
                directly shape this survivorship curve. As noted in the Black & Moore chapter (p.401), these survival patterns
                are major determinants of vectorial capacity and transmission dynamics.
                """)
                ...
                if len(cohort_df) > 1:
                    # Use logarithmic regression to estimate daily survival (p) as in equation 17, 18 in the text
                    ...
                    try:
                        ...
                        **Estimated Daily Survival Rate:** {estimated_daily_survival:.4f}
                        ...
                        probability of survival across all stages (equation m = p^d from the text). This is comparable to the
                        daily survivorship (p) value that appears in the vectorial capacity equations.
                        """)
                    except:
                        pass
        else:
